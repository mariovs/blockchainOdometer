...
public class AssetDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String assetId = getIntent().getStringExtra(Constants.assetIdConstant);
    ...
    {
        CustomQRDialog customQRDialog = new CustomQRDialog(this, asset.getFirstTransactionId());
        customQRDialog.show();
    }
    ...
    {
        CustomQRDialog customQRDialog = new CustomQRDialog(this, asset.getPublicKey());
        customQRDialog.show();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(intentResult != null)
        {
            if(intentResult.getContents() == null)
            {
                ...
                RetrofitClient.getService().transferCarAsset(asset.getPrivateKey(),receiverPublicKey, asset.getFirstTransactionId()).enqueue(new Callback<JsonObject>() {
                    @Override
